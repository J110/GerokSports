...
**Phase 1 second-pillar productive-work chain.** **COMPLETE.** WS-Per-Batter-Ledger → WS-L → WS-M (11 commits + 1 empirical + 1/5 budget consumed across the chain). Cheap-wins phase has narrowed to its structural floor. Remaining Phase 1 admissible work: assertion-side WS-I-pattern reuse only (per S28 pre-screen). Pipeline-plumbing arcs + external-corroboration pivots are **unaffordable at 1/5 budget** until budget recovery via subsequent 0/5-budget workstreams.
