...
**Last update.** 2026-05-23 (WS-L primary CLOSED — assertion-side discriminator shipped + downstream fix surface localized to over_mgr orphan-bind via step-1b code-reading refinement; **S28 PROMOTED** to numbered insight — pre-screen fix-surface-category before opening Phase 1 step-1 memos; WS-M opens as pipeline-plumbing follow-on with inherited 4 LIVE-FAIL cohort).
