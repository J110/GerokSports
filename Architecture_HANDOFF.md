...
**Last update.** 2026-05-23 (WS-Per-Batter-Ledger primary CLOSED — trace_alpha_batter_runs_sum cohort discriminator shipped at `110026d`; 4 LIVE-FAILs surfaced for WS-L HC follow-on observability-completeness audit; S28 pre-screen methodology validated single-instance; L1.5 70 → 75 cases).
