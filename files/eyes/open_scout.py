...
OPEN_PROMPT = (
    ...
    "NOT the live action.\n\n"
    "Special broadcast modes: if (and ONLY if) you can see a "
    "REPLAY label, a SLO-MO / SUPER SLO-MO tag, telestrator "
    "drawings, freeze-frame analysis arrows, or a split-screen "
    "replay layout, explicitly name the indicator you see (e.g. "
    "\"a REPLAY label is visible\" or \"the frame shows a "
    "telestrator drawing\"). If none of these are present, do NOT "
    "mention replay, slow-motion, telestrator, or split-screen "
    "anywhere in your description — they are not relevant to "
    "non-replay frames.\n\n"
